...
const tabs = [
  ...
  { to: "/ocr", label: "OCR", icon: CameraIcon },
  { to: "/cards", label: "Cardbook", icon: Squares2X2Icon },
  { to: "/profile", label: "Profile", icon: UserCircleIcon },
];

const BottomNavigation = () => {
  return (
    <nav className="fixed inset-x-0 bottom-5 z-50 mx-auto max-w-md px-5">
      <div className="flex items-center justify-around rounded-3xl bg-white/90 p-3 shadow-xl backdrop-blur">
